...
if __name__ == "__main__":
    ...
    #q_field = str(raw_input("select query field > "))
    field = str(raw_input("select delete field > "))
    #value = str(raw_input("select value > "))
    ...
    while (result_count > 0):
        ...
        search_result = []
        post_data = json.dumps({"size": 1000, "query": {"filtered": {"query": {"bool": {"must": {"match": {"_img_cached": True}}}}, "filter": {"missing": {"field": "cached_img_urls"}}}}})
